...
Changes done in this fork copyright (c) 2019, 2020 Fredrik Lindeberg
...
An example of the Internet as generated by data from 2016. The grapher can in theory handle any kind of data in ncol-format, although all the helper scripts I have added focus on parsing and handling BGP- and similar data. 
